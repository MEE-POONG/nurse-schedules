...
export default function ModalSelectMonthRed({
  userId,
  Duty,
  day,
  name,
                      ...
                      <div className="w-full px-3">
                        ...
                        <div className="grid grid-cols-3">
                          {Shif?.map((shif, index) => (
                            ...
                            >
                              <label
                                className={`${ruleDuty(shif.name) === true ? 'bg-white print:bg-white print:text-black' : 'bg-white'} p-3 justify-between flex w-full pr-8 border-gray-400 rounded-md text-lg focus:border-teal-600 focus:ring-teal-600`}
                              >
                                <div className="flex items-center mr-4">
                                  <input
                                    ...
                                    type="checkbox"
                                    value={shif.name}
                                    className="w-4 h-4 bg-white border-gray-300 cursor-pointer print:bg-white print:text-black accent-teal-700 disabled:cursor-auto"
                                  ...
                                  <label
                                    htmlFor={"shift" + index}
                                    className={`ml-2 text-lg font-medium text-gray-700 ${shif.class ? " circle-red text-black text-sm w-[20px] h-[20px] block " : ""}`}
                                  >
                                    {shif.name}
                                  </label>
                                </div>
