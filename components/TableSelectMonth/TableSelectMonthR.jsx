          ...
          <table className="border-collapse border text-center border-spacing-2 mx-auto text-lg whitespace-nowrap">
            <tbody>
              ...
              {user?.map((person, key) => {
                ...
                return (
                  <tr key={key} className="border border-black bg-white">
                    ...
                    <td className="border border-black text-right">{((workingDay + ot) * person.overtime_compensation).toLocaleString('TH-th')}</td>
              ...
              {/* {user?.filter(e => e.Position.name === 'พนักงานเปล')?.length ? <tr className="border">
                ...
                <td className="border border-black">&nbsp;</td>
                <td className="border border-black" colSpan={daysInMonth}>
                  รวมจ่ายเงินทั้งสิ้น = {THBText(((sumDutyPay(["ช", "บ", "ด", "R"]) + sumOTPay()) * 360)) || 'ศูนย์บาทถ้วน'}
                </td>
                ...
                <td className="border border-black text-right">
                  {((sumDutyPay(["ช", "บ", "ด", "R"]) + sumOTPay()) * 360).toLocaleString('TH-th')}
                </td>
                <td className="border border-black">&nbsp;</td>
                <td className="border border-black">&nbsp;</td>
              </tr> : ''} */}
                ...
                >
                  ...
                  <div className="justify-between w-full hidden lg:flex">
                    ...
                    <div className="basis-6/12">
                      <p className="text-center mt-3">ลงมือชื่อ......................................................................นายแพทย์ชำนาญการ รักษาการในตำแหน่งผู้อำนวยการโรงพยาบาลครบุรี(ผู้อนุมัติ)</p>
                      <p className="text-left pl-52">( นายเรืองศักดิ์  ใจโพธิ์)</p>
                    </div>
                    <div>
