...
ระบบจัดและบริหารตารางเวรพยาบาลสำหรับโรงพยาบาลกระบี่ (หน่วย ICU เป็นหลัก) พัฒนาด้วย **Next.js + MongoDB (Prisma)** รองรับการจัดเวรปกติ เวรควบ เวร OT เวร On-Call การจองเวรล่วงหน้า การจัดเวรอัตโนมัติตามกฎ และการออกรายงาน/พิมพ์ตารางเวรราชการรายเดือน รวมถึงส่งออกเป็นไฟล์ Excel
